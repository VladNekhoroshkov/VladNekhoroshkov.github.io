<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyCart.aspx.cs" Inherits="Pages_MyCart" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        <div class="row orange card header">
                <div class="col s2">
                    <span class="brand">BasketShop</span>
                </div>
        ...
        <input style="display: none" runat="server" id="field" value="notSelected" type="text" class="hidden"/>
